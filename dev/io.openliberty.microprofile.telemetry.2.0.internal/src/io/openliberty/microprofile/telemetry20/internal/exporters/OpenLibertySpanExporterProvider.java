...
public class OpenLibertySpanExporterProvider implements ConfigurableSpanExporterProvider, AutoConfigureListener {
    ...
    public SpanExporter defaultCreateExporterWrapper(ConfigProperties config) {
