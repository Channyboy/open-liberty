...
public class MonitorSimpleTimer extends SimpleTimerImpl {
    ...
    private long  ddisplayMaxOld_thisMinute_val = 0L;
    private long  displayMinOld_thisMinute_val = 0L;
    ...
    public synchronized Duration getMaxTimeDuration() {
    	...
    	System.out.println("displayMaxOld_thisMinute " + displayMaxOld_thisMinute);
    	System.out.println("displayMaxCurrent_thisMinute " + displayMaxCurrent_thisMinute);
    	System.out.println("minuteOld " + minuteOld);
    	System.out.println("cachedMaxOldMinute " + cachedMaxOldMinute);
    	...
    	{
    		System.out.println("old display - MAX");
    	...
    	{
    		System.out.println("new display - MAX");
    ...
    public synchronized Duration getMinTimeDuration() {
    	...
    	{
    		System.out.println("old display - MIN");
    	...
    	if ((cachedMinCurrentMinute != minuteCurrent || displayMinCurrent_thisMinute == currentMinute) //NOT stale unless still displaying
    			&& currentMinute != minuteCurrent)
    	{
    		System.out.println("new display - MIN");
