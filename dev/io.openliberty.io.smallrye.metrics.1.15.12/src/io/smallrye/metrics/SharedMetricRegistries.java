...
public class SharedMetricRegistries {
    ...
    private static final String FQ_PROMETHEUS_CONFIG_PATH = "io.micrometer.prometheusmetrics.PrometheusConfig";
    private static final String FQ_PROMETHEUS_METRIC_REGISTRY_PATH = "io.micrometer.prometheusmetrics.PrometheusMeterRegistry";
    ...
    static {
        ...
        for (Class<?> clazz : MicrometerBackends.classes()) {
            try {
                final RequiresClass requiresClass = clazz.getAnnotation(RequiresClass.class);
