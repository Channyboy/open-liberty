...
public class SimpleTimer30Impl implements SimpleTimer {
    ...
    public Duration getMaxTimeDuration() {
        maybeStartNewMinute();
        // return (max_previousMinute.get() == 0) ? Duration.ZERO.minus(Duration.ofNanos(1)) : Duration.ofNanos(max_previousMinute.get());
    ...
    public Duration getMinTimeDuration() {
        maybeStartNewMinute();
//        return (min_previousMinute.get() == 0) ? Duration.ZERO.minus(Duration.ofNanos(1)) : Duration.ofNanos(min_previousMinute.get());
