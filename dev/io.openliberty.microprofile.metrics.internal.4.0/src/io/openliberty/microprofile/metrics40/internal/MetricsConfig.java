...
@Component(service = { MetricsConfig.class }, configurationPid = "io.openliberty.microprofile.metrics", configurationPolicy = ConfigurationPolicy.OPTIONAL, immediate = true, property = { "service.vendor=IBM" })
